...
def read_values(first_values,second_values,third_values):
    """
...
def main(pub_f,pub_s,pub_t):
    ...
    max_speed = 0.2 #only for second and third
    ...
    while not rospy.is_shutdown():
        read_values(first_values,second_values,third_values) #read sensor values
...
def init():
    ...
    return pub_f,pub_s,pub_t

if __name__ == '__main__':
    try:
        pub_f,pub_s,pub_t=init()
        main(pub_f,pub_s,pub_t)
